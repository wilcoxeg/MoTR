...
saveRDS(fit_reg_rank, file = paste0("./bayesian_models_cor/origin_motr_eyetr_FPReg_cor.rds"))
...
```{r}
fit_rank_all = readRDS("./bayesian_models_cor/ranked_motr_eyetr_FPReg_cor.rds")
fit_rank_all_drop0s = readRDS("./bayesian_models_cor/ranked_motr_eyetr_FPReg_cor_drop0s.rds")

fit_origin_all = readRDS("./bayesian_models_cor/origin_motr_eyetr_FPReg_cor.rds")
fit_origin_all_drop0s = readRDS("./bayesian_models_cor/origin_motr_eyetr_FPReg_cor_drop0s.rds")

efit_rank_all = readRDS("./bayesian_models_cor/ranked_eyetr_eyetr_FPReg_cor.rds")
