        ...
        <Screen :key="i" class="main_screen">
          <Slide>
            <form>
              ...
              <input type="hidden" class="experiment" :value="trial.experiment_id">
              <input type="hidden" class="condition" :value="trial.condition_id">
            </form>
    ...
    methods: {
      ...
      saveData() {
          if (this.currentIndex !== null) {
            ...
            if (currentElement) {
              $magpie.addTrialData({
                Experiment: this.$el.querySelector(".experiment").value,
