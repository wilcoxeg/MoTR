---
title: "Analysis for MoTR Reading Data"
...
plotting_df %>%
  ...
  ggplot(aes(x = sent_rg_id, y = m, color = measure, linetype = measure)) +
    ...
    geom_line() +
    geom_text(aes(label = cris, y = if_else(metric == "Regression Prob", m + 0.07, m + 130) ), size =2.2) +
    geom_text(aes(x = 0, y = if_else(metric == "Regression Prob", 0.18, 380), label=""), show.legend = FALSE) +
...
ggsave(paste0("../visualizations/target_results_cris.pdf"), device="pdf", width = 8, height = 5.5)
