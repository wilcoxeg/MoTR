...
write.csv(plotting_df, "gamma_provo_surprisal_bayesian_with0s_2.csv", row.names = FALSE)
...
# ggsave("../visualization/paper/surp_rt_wt_gamma_with0s.pdf", device = "pdf", width = 6, height = 2.5)
...
```{r}
# for check models & get priors
gd = read_rds("./bayesian_models_surp/with0s/gamma_provo_gaze_duration_Bootstrap12.rds")
gd2 = read_rds("./bayesian_models_surp/with0s/gamma_provo_gaze_duration_Bootstrap02.rds")
td = read_rds("./bayesian_models_surp/with0s/gamma_provo_total_duration_Bootstrap02.rds")
td2 = read_rds("./bayesian_models_surp/with0s/gamma_provo_total_duration_Bootstrap02.rds")
  
```

```{r}
stancode <- stancode(gd)
class(stancode)
stancode

fit_data <- standata(gd)


writeLines(stancode, "./stan_models/provo_surp.stan")
```

```{r}
print(fit_data$N)
print(class(fit_data$knots_3))
print(fit_data$prior_only)
```
