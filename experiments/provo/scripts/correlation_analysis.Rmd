...
saveRDS(fit_gd, file = paste0("./bayesian_models_cor/cor_bivariate/motr_eyetr_gaze_duration_cor_drop0s.rds"))
...
saveRDS(fit_gpt, file = paste0("./bayesian_models_cor/cor_bivariate/motr_eyetr_go_past_time_cor_drop0s.rds"))
```
...
saveRDS(fit_td, file = paste0("./bayesian_models_cor/cor_bivariate/motr_eyetr_total_duration_cor_drop0s.rds"))
```
...
saveRDS(fit_reg, file = paste0("./bayesian_models_cor/cor_bivariate/motr_eyetr_FPReg_cor.rds"))
```
...
# models for drop 0s
fit_gd = readRDS("./bayesian_models_cor/motr_eyetr_gaze_duration_cor_drop0s.rds")
fit_gpt = readRDS("./bayesian_models_cor/motr_eyetr_go_past_time_cor_drop0s.rds")
fit_td = readRDS("./bayesian_models_cor/motr_eyetr_total_duration_cor_drop0s.rds")
fit_reg = readRDS("./bayesian_models_cor/ranked_motr_eyetr_FPReg_cor.rds")
...
saveRDS(fit_egd, file = paste0("./bayesian_models_cor/cor_bivariate/eyetr_eyetr_gaze_duration_cor.rds"))
...
saveRDS(fit_egpt, file = paste0("./bayesian_models_cor/cor_bivariate/eyetr_eyetr_go_past_time_cor.rds"))
...
saveRDS(fit_etd, file = paste0("./bayesian_models_cor/cor_bivariate/eyetr_eyetr_total_duration_cor.rds"))
```
...
fit_ereg = readRDS("./bayesian_models_cor/ranked_eyetr_eyetr_FPReg_cor.rds")
print('---------------------------- Gaze Duration--------------------------------------------')
print(fit_egd)
print('---------------------------- Go Past Time--------------------------------------------')
print(fit_egpt)
...
saveRDS(fit_mfreq, file = paste0("./bayesian_models_cor/cor_bivariate/motr_freq_cor.rds"))
```
...
saveRDS(fit_efreq, file = paste0("./bayesian_models_cor/cor_bivariate/eyetr_freq_cor.rds"))
```
...
saveRDS(fit_mlen, file = paste0("./bayesian_models_cor/cor_bivariate/motr_len_cor.rds"))
...
saveRDS(fit_elen, file = paste0("./bayesian_models_cor/cor_bivariate/eyetr_len_cor.rds"))
```
...
saveRDS(fit_msurp, file = paste0("./bayesian_models_cor/cor_bivariate/motr_surp_cor.rds"))
...
saveRDS(fit_esurp, file = paste0("./bayesian_models_cor/cor_bivariate/eyetr_surp_cor.rds"))
