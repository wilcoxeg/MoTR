<!-- Window is fixed, medium 100px, less gradual blurry, pointer cursor-->
<!-- Comprehension questions appear at the same time -->
  ...
  <style>
    ...
    .oval-cursor.grow {
      ...
      /* background-color: rgba(255, 255, 255, 0.3);npm  */
