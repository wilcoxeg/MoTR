<!-- Window is fixed, 100px, no cursor, more gradual blurry effect on surrounding words. -->
      ...
      <template v-for="(trial, i) of trials">
        <Screen :key="i" class="main_screen">
          <Slide>
            ...
            <button v-if="showFirstDiv" style= "bottom:50%; transform: translate(-50%, -50%)" @click="toggleDivs">
            Done
            </button>
