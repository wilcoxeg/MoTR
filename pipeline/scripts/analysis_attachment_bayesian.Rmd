...
# stats_df_bayesian <- read.csv("../results_data/lc_stats_bayesian_all_data.csv")
...
ggsave(paste0("../visualization/paper/model_estimates", rate, ".pdf"), device="pdf", width = 8, height =5)
...
ggsave(paste0("../visualization/paper/model_estimates_regression", rate, ".pdf"), device="pdf", width = 8, height =1.2)
