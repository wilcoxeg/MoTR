...
if __name__ == '__main__':
    ...
    # input_paths_trial_1 = Path('./preprocessed_trialData/filtered_preprocessed_localCoherence_list1.csv')
    # input_paths_trial_2 = Path('./preprocessed_trialData/filtered_preprocessed_localCoherence_list2.csv')
    # input_paths_trial_3 = Path('./preprocessed_trialData/filtered_preprocessed_localCoherence_list3.csv')
    # input_paths_trial_4 = Path('./preprocessed_trialData/filtered_preprocessed_localCoherence_practice.csv')
    # df1 = pd.read_csv(input_paths_trial_1)
    # df2 = pd.read_csv(input_paths_trial_2)
    # df3 = pd.read_csv(input_paths_trial_3)
    # df4 = pd.read_csv(input_paths_trial_4)
