...
if __name__ == '__main__':
    ...
    # output_path_f = Path('./fixations_merged/f160_b40')
    ...
    #     objMerger = FixationMerger(input_path, output_path_f, 160, 40)
    ...
    # input_paths_l = Path('./fixations_merged/f160_b40').glob('*_denoised.csv')
    # output_path_l = Path('./reading_measures/cleaned_f160_b40')
    #
